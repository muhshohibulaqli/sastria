...
<div class="main-card">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <button
            ...
            data-bs-target="#modalTambahPangkat"
        >
...
<a
href="{{ asset('storage/'.$item->file_pangkat) }}"
target="_blank"
...
onclick="document.getElementById('upload-pangkat{{ $item->id }}').classList.toggle('d-none')"
>
